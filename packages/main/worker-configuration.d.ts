/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8a784d49b716005195c6ff93a98465a6)
// Runtime types generated with workerd@1.20260923.1 2026-09-04
interface __BaseEnv_Env {
	ADMIN_EMAIL: string;
	ADMIN_PASSWORD: string;
	SESSION_SECRET: string;
	AUTH_PENDING_SECRET: string;
	AUTH_CHALLENGE_SECRET: string;
	AUTH_ENC_KEY: string;
	TURNSTILE_SITE_KEY: string;
	TURNSTILE_SECRET_KEY: string;
	WEBAUTHN_RP_ID: string;
	WEBAUTHN_ORIGIN: string;
	STREAMS: DurableObjectNamespace<import("./src/server/worker").StreamObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/worker");
		durableNamespaces: "StreamObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_EMAIL" | "ADMIN_PASSWORD" | "SESSION_SECRET" | "AUTH_PENDING_SECRET" | "AUTH_CHALLENGE_SECRET" | "AUTH_ENC_KEY" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "WEBAUTHN_RP_ID" | "WEBAUTHN_ORIGIN">> {}
}
