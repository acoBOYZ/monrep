...
const alertVariants = cva("flex w-full items-stretch gap-2 group-[.toaster]:w-(--width)", {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      appearance: "light",
      className:
        "border border-destructive bg-destructive text-destructive-foreground [&_[data-slot=alert-icon]]:text-destructive-foreground",
    },
    {
      variant: "success",
      appearance: "light",
...
function AlertContent({ className, ...props }: HTMLAttributes<HTMLParagraphElement>) {
  return (
    <div
